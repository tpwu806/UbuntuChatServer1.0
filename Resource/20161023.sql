...
CREATE TABLE `friends` (
  ...
  `DSTATUS` int(2) DEFAULT NULL COMMENT '是否在线',
...
insert  into `grouptable`(`GNO`,`GNAME`,`GDATE`) values (10001,'我们的回忆','2016-10-22 23:11:56'),(10002,'游泳俱乐部','2016-10-22 23:12:00');
...
insert  into `usergroup`(`UGNO`,`UC`,`GNO`) values (1,77777,10001),(2,88888,10001),(3,99999,10001),(4,99999,10002);
