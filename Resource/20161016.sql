...
CREATE TABLE `user_group` (
  `UGNO` int(2) NOT NULL COMMENT '关系编号',
  `UC` int(5) NOT NULL COMMENT 'uc号',
  `GNO` int(5) NOT NULL COMMENT '群编号',
  PRIMARY KEY (`UGNO`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
insert  into `userinfo`(`UC`,`PWD`,`SIGN`,`PHOTOID`,`NICKNAME`,`SEX`,`BIRTHDAY`,`CONSTELLATION`,`BLOODTYPE`,`DIPLOMA`,`TELEPHONE`,`EMAIL`,`ADDRESS`) values (77777,'123','想睡觉',1,'system3','男','2016-10-16','狮子','B','博士','1212121212112','vito@163.com','香港'),(88888,'123','无聊',1,'system2','男','2016-10-16','狮子','B','本科','186172638127','vito@qq.com','北京'),(99999,'123','just for fun ！',1,'system1','男','2016-10-16','狮子','B','本科','18366121000','vito@live.com','济南');
